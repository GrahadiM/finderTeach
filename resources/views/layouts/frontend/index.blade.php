...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('images/settings/') }}{{ \Setting::getSetting()->favicon }}" rel="icon">
        ...
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">
                    &copy; <a href="{{ route('frontend.index') }}">{!! \Setting::getSetting()->footer_web !!}</a>. All Rights Reserved.
                </p>
            </div>
